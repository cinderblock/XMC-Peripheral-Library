 ...
 * @version 1.0.0
 *
 * @brief SDMMC driver for XMC4500 microcontroller
 *
 * History <br>
 *
...
/* Get SDMMC driver version */
XMC_DRIVER_VERSION_t XMC_SDMMC_GetDriverVersion(void)
{
  XMC_DRIVER_VERSION_t version;

  version.major = XMC_SDMMC_MAJOR_VERSION;
  version.minor = XMC_SDMMC_MINOR_VERSION;
  version.patch = XMC_SDMMC_PATCH_VERSION;
