...
/**
 * SDMMC low level driver: Major number
 */
#define XMC_SDMMC_MAJOR_VERSION (1U)

/**
 * SDMMC low level driver: Minor number
 */
#define XMC_SDMMC_MINOR_VERSION (0U)

/**
 * SDMMC low level driver: Patch number
 */
#define XMC_SDMMC_PATCH_VERSION (2U)
 ...
 */
XMC_DRIVER_VERSION_t XMC_SDMMC_GetDriverVersion(void);
